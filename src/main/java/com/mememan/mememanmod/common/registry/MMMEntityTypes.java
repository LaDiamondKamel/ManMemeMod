...
public final class MMMEntityTypes {
    ...
    public static final RegistryObject<EntityType<RatRod>> RATROD = ENTITY_TYPES.register("ratrod", () -> EntityType.Builder.of(RatRod::new, MobCategory.CREATURE).sized(0.5F, 0.3F).build(new ResourceLocation(ManMemeMod.MODID, "ratrod").toString()));
}
